/* checksum : e79be0151b432c645273181c1de15df2 */
@cds.external : true
@m.IsDefaultEntityContainer : 'true'
@sap.message.scope.supported : 'true'
@sap.supported.formats : 'atom json xlsx'
service API_ENTERPRISE_PROJECT_SRV {
  @cds.external : true
  ...
  entity A_EnterpriseProjectElement {
    ...
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    ChangePeriodDistributionOption_ac : Boolean;
    @odata.Type : 'Edm.Byte'
    ...
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    MilestoneApprovalStatus_fc : Integer;
    @odata.Type : 'Edm.Byte'
    @sap.label : 'Dyn. Field Control'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    ...
    @sap.label : 'Planned Finish'
    @sap.quickinfo : 'Planned Finish Date'
    PlannedEndDate : Date;
    @sap.display.format : 'Date'
    ...
    @sap.display.format : 'Date'
    @sap.field.control : 'ForecastedEndDate_fc'
    @sap.label : 'Forecasted Finish'
    ForecastedEndDate : Date;
    @sap.display.format : 'UpperCase'
    @sap.field.control : 'MilestoneApprovalStatus_fc'
    @sap.label : 'Milestone Apprvl Sts'
    @sap.quickinfo : 'Milestone Approval Status'
    MilestoneApprovalStatus : String(5);
    @sap.field.control : 'IsMainMilestone_fc'
    @sap.label : 'Main Milestone'
    @sap.quickinfo : 'Milestone is essential for Project Planning'
    ...
    action ChangePeriodDistributionOption(
      @sap.label : 'Planned Start'
      @sap.display.format : 'Date'
      PlannedStartDate : Date,
      @sap.label : 'Planned Finish'
      ...
      EntProjElmntDistributionOption : Integer
    ) returns A_EnterpriseProjectElement;
  };
  ...
  entity A_EnterpriseProject {
    ...
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    CopyToActiveDocument_ac : Boolean;
    @odata.Type : 'Edm.Byte'
    @sap.label : 'Dyn. Field Control'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    ...
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    EntProjHasProjectStockEnabled_fc : Integer;
    @odata.Type : 'Edm.Byte'
    @sap.label : 'Dyn. Field Control'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    ...
    @sap.updatable : 'false'
    CreationDateTime : DateTime;
    @sap.field.control : 'EntProjHasProjectStockEnabled_fc'
    @sap.label : 'Project stock'
    EntProjHasProjectStockEnabled : Boolean;
    @sap.display.format : 'UpperCase'
    @sap.label : 'Spec. stk valuation'
    @sap.quickinfo : 'Valuation of Special Stock'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    InventorySpecialStockValnType : String(1);
    to_EnterpriseProjectElement : Composition of many A_EnterpriseProjectElement on to_EnterpriseProjectElement.ProjectUUID = ProjectUUID;
    // to_EnterpriseProjectJVA : Composition of A_EnterpriseProjectJVA  on to_EnterpriseProjectJVA.ProjectUUID = ProjectUUID;
    ...
    action CopyToActiveDocument(
      @sap.label : 'TRUE'
      EntProjDemandCopyIsRequested : Boolean,
      @sap.label : 'TRUE'
      EntProjSettlmtRuleCpyIsReqd : Boolean,
      @sap.label : 'Project ID'
      Project : String(24),
      @sap.label : 'Name'
  ...
  @sap.deletable : 'false'
  @sap.content.version : '2'
  @sap.label : 'Project Element Work Item Text'
  entity A_EntProjElmntCnfgrdWrkItmTxt {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Work Item ID'
    key EntProjElmntWorkItem : String(10) not null;
    @sap.label : 'Language Key'
    key Language : String(2) not null;
    @sap.label : 'Work Item Name'
    EntProjElmntCnfgrdWrkItmName : String(40);
  };
  ...
  entity A_EntProjElmntWorkItem {
    ...
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    EntProjElmntWorkItem_fc : Integer;
    @odata.Type : 'Edm.Byte'
    @sap.label : 'Dyn. Field Control'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    EntProjElmntWorkItemIsCnfgrd_fc : Integer;
    @odata.Type : 'Edm.Byte'
    @sap.label : 'Dyn. Field Control'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    EntProjElmntWorkItemName_fc : Integer;
    @sap.label : 'Dyn. Method Control'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    ...
    Update_mc : Boolean;
    @sap.display.format : 'UpperCase'
    @sap.field.control : 'EntProjElmntWorkItem_fc'
    @sap.label : 'ProjElmnt Work Item'
    @sap.quickinfo : 'Enterprise Project Element Work Item'
    EntProjElmntWorkItem : String(10);
    @sap.field.control : 'EntProjElmntWorkItemName_fc'
    @sap.label : 'Work Item Name'
    ...
    @sap.field.control : 'EntProjElmntWorkItemIsCnfgrd_fc'
    ...
    to_EnterpriseProjectElement : Association to A_EnterpriseProjectElement {  };
    to_ConfiguredWorkItemText : Association to many A_EntProjElmntCnfgrdWrkItmTxt {  };
    to_EnterpriseProject : Association to A_EnterpriseProject {  };
  };

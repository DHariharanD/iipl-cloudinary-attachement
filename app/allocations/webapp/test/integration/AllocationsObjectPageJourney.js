...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("AllocationsObjectPageObjectPage journey");

        opaTest("Navigate to AllocationsObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();

            When.onTheAllocationsList.onFilterBar().iExecuteSearch();

            Then.onTheAllocationsList.onTable().iCheckRows();
            When.onTheAllocationsList.onTable().iPressRow(0);

            Then.onTheAllocationsObjectPage.iSeeThisPage();
        });

...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "ns/allocations/test/integration/FirstJourney",
    "ns/allocations/test/integration/AllocationsListJourney",
    "ns/allocations/test/integration/AllocationsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});

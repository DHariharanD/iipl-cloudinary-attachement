sap.ui.define([
    ...
    return {
         ...
         */
        onUploadAllocation: function(oContext, aSelectedContexts) {
                    ...
                    press: function () {
                        ...
                        reader.onload = async function (e) {
                            ...
                            try {
                                ...
                                await oModel
                                        .bindContext("/uploadAllocation(...)")
                                        .setParameter("file", base64)
                                        .execute();

                                MessageToast.show("Allocation uploaded successfully");
                                oModel.refresh();
                            } catch (error) {
                                console.log(error);
                                MessageToast.show("Allocation upload failed");
                            }

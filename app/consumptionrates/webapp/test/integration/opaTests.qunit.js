...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "ns/consumptionrates/test/integration/FirstJourney",
    "ns/consumptionrates/test/integration/ConsumptionRatesListJourney",
    "ns/consumptionrates/test/integration/ConsumptionRatesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
